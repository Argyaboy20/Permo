...
switch($aksi)
{
    case "add_register":
        ...
        $pass = filter_var($postjson['pass'], FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);
        $konfirmasi = filter_var($postjson['konfirmasi'], FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);
       
        try {
            $sql = "INSERT INTO daftar (username,email,pass,konfirmasi) VALUES (:username, :email, :pass, :konfirmasi)";
